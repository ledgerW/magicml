try:
    ...
    print('Using SM injected Env Vars')
...
def train(
    ...
    saved_model_path = model_dir + '/{}'.format(model_name)
    logging.info(saved_model_path)

    gpl.train(
        path_to_generated_data=train_path,
        ...
        batch_size_generation=batch_size_qgen,
        gpl_steps=steps,
        new_size=-1,
